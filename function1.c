 ...
 * @size: Size specifier
 * Return: unsigned number of chars
 */
 ...
 * Return: unsigned number of chars printed
 */
...
/**
 * print_hexa_upper - this prints an unsigned number
 ...
 * @precision: Precision specification
 * @size: Size specifier
 * Return: Number in upper hexadecimal notation
 */
 ...
 * @size: Size specifion
 * @size: Size specification
 * Return: specified parameters to be printed
 */
